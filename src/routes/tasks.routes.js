...
const { getAllBooks, getABook, deleteABook, putABook, postABook, postAStudent, getStudents, postLendBook, getStudent, getPrestamos, getPrestamo, updatePrestamo } = require('../controllers/tasks.controller')
